      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: 'dept-feedback',
              name: 'opinion-dept-feedback-list',
              component: () => import('@/views/opinion/dept-feedback/List.vue'),
              meta: { title: '专业部门反馈', icon: IconBookmark },
            },
            {
              path: 'dept-feedback/:taskId',
              name: 'opinion-dept-feedback-detail',
              component: () => import('@/views/opinion/dept-feedback/Detail.vue'),
              meta: { title: '专业部门反馈详情', hidden: true },
            },
            {
              path: 'dept-audit',
              name: 'opinion-dept-audit-list',
              component: () => import('@/views/opinion/dept-audit/List.vue'),
              meta: { title: '专业部门反馈审核', icon: IconBookmark },
            },
            {
              path: 'dept-audit/:taskId',
              name: 'opinion-dept-audit-detail',
              component: () => import('@/views/opinion/dept-audit/Detail.vue'),
              meta: { title: '专业部门反馈审核详情', hidden: true },
            },
          ],
        },
      ],
